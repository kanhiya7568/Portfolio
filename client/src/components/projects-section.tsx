          ...
          >
            {projects.map((project, index) => (
              <motion.div 
                ...
                className={`bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 ${project.isLarge ? 'md:col-span-2 lg:col-span-2' : ''} ${project.title.includes('Ayurvedic AI') ? 'border-2 border-yellow-500' : ''}`}
                whileHover={{ scale: 1.02 }}
              >
                <div className="h-48 bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center relative">
                  {project.title.includes('Ayurvedic AI') && (
